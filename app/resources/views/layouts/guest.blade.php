...
<body class="min-h-screen flex">
    ...
    <div class="hidden lg:flex flex-col justify-between w-[55%] p-12 relative overflow-hidden"
        ...
        <div class="relative">
            <a href="/" class="flex items-center gap-3">
                ...
                <span class="text-white font-bold text-xl">ChatooAI</span>
            </a>
        </div>
        ...
        <div class="relative glass-card rounded-2xl p-5">
            <p class="text-slate-300 text-sm italic mb-3">"ChatooAI handles 80% of our WhatsApp inquiries automatically. It's like having a full-time support agent for free."</p>
    ...
    <div class="flex-1 flex flex-col items-center justify-center p-8 min-h-screen" style="background:#070e1f;">
        ...
        <p class="mt-8 text-center text-xs text-slate-700">
            © {{ date('Y') }} ChatooAI · <a href="/" class="hover:text-slate-500 transition-colors">Back to Home</a>
        </p>
    </div>
